...
const ContractBrandManagement = () => {
  ...
  const handleSubmit = async () => {
    ...
    try {
      if (editId) {
        await updateContractBrand(editId, form);
        showFeedback("Brand aggiornato");
      } else {
        await addContractBrand(form);
    ...
    <div>
      ...
      <div className="card mb-4">
        <div className="card-body">
          <h5 className="card-title mb-3">{editId ? "Modifica Brand Contract" : "Aggiungi Brand Contract"}</h5>
...
export default ContractBrandManagement;
